...
@section('title'){{$paket->nama_paket}} @endsection
        ...
        <div class="tab-content">
          <div id="perencanaan" class="tab-pane fade in active"><br>
              ...
              <div class="pull-right">
                <a href="#" class="btn btn-danger edit-record" data-toggle="modal" data-target="#myModal1" ><i class="fa fa-comment"><strong>&nbsp;&nbsp;&nbsp; Formulir Komentar</strong></i></a>
              </div>
            </div>
            <div class="row">
              <div class="col-xs-12">
