...
@section('title')Dikontrak {{$peserta->peserta}} -  @endsection
...
<section class="ftco-section ftco-no-pt bg-light">
	...
	<div class="container">
		...
		<div class="row bg-white p-3">
			<div class="col">
              <h4 class="text-uppercase mt-3 mr-2 text-hijau" style="display: inline;"><b><i class="fas fa-briefcase"></i> Lelang yang dikontrak {{$peserta->peserta}} tahun {{$tahun}} </b>
              </h4>
				<hr>
				<div class="table table-responsive">
	              <table class="table table-striped" id="datarup">
	                ...
	                <tbody class="bg-white">
	                	@if($kontraktender)
	                	@foreach($kontraktender as $result)
	                	<tr>
	                	...
	                	@endif
	                	@if($kontraknontender)
	                	@foreach($kontraknontender as $result)
	                	<tr>
