...
@section('title')Proses RUP {{$tahun}} - Sistem Informasi Pemantauan Pengadaan Publik @endsection
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Rup Proses</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/admin">Home</a></li>
              <li class="breadcrumb-item"><a href="/admin/rup/2020">Rup</a></li>
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row mt-3">
          <div class="col">
            <form action="{{route('admin.rup.prosesrup', $tahun)}}" method="POST">
              @csrf
              <div class="form-inline">
                <h4 class="text-uppercase mt-3 mr-2" style="display: inline;"><b>Rencana Umum Pengadaan Tahun </b>
                  <select name="tahun" class="form-control" style="width: 100px;display: inline;" onchange="changefunction(this)">
                    <option>{{$tahun}}</option>
                ...
                <button type="submit" class="btn btn-success mr-2 mt-2"><i class="fas fa-sync"></i> Update Proses</button><!-- 
...
<script type="text/javascript">
  $(document).ready(function() {
    $('#datarup').DataTable({
      ...
      order: [[0, 'asc']],
      ajax : {
        url : "{{route('admin.rup.proses', $tahun)}}",
        type : 'GET'
      },
      columns: [
        {data:'kdli',name:'kdli'},
      ...
      },
      {
        targets : [5],
        render : function (data, type, row) {
          var btn = "<center><a href=\"/admin/rup/<?= $tahun ?>/"+data+"\" class=\"btn btn-info btn-sm\" target=\"_blank\"><i class=\"fas fa-arrow-right\"> Detail</i></a></center>";
          return btn;
        }
      }
