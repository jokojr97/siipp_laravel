...
@section('title')Non Tender {{$tahun}} - Sistem Informasi Pemantauan Pengadaan Publik @endsection
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Non Tender</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col">
            <div class="form-inline">
              ...
              <a href="{{route('admin.nontender.sync', $tahun)}}" class="btn btn-info mr-2 mt-2"><i class="fas fa-sync"></i> &nbsp;Sinkronisasi</a>
              <a href="{{route('admin.nontender.import', $tahun)}}" class="btn btn-primary mr-2 mt-2"><i class="fas fa-file-import"></i> &nbsp;Import</a>
              <a href="{{route('admin.nontender.export', $tahun)}}" class="btn btn-danger mr-2 mt-2"><i class="fas fa-file-export"></i> &nbsp;Eksport</a>              
            </div>
            <br>  
...
<script type="text/javascript">
  function changefunction(id) {
    var idss = id.value;
    window.location.replace("/admin/nontender/"+idss+"");  
  }
</script>
...
<script type="text/javascript">
  $(document).ready(function() {
    $('#datatender').DataTable({
      ...
      order: [[0, 'asc']],
      ajax : {
        url : "{{route('admin.nontender.tahun', $tahun)}}",
        type : 'GET'
      },
      columns: [
